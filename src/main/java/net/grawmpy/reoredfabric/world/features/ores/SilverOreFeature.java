...
public class SilverOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("reoredfabric:silver_ore", FEATURE, new OreConfiguration(SilverOreFeatureRuleTest.INSTANCE, ReoredfabricModBlocks.SILVER_ORE.defaultBlockState(), 3));
